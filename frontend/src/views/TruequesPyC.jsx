  ...
  /*const obtenerPendientes = (trueques) => {
    if (trueques) {
      ...
      if (usuarioActual.rol == 2) {
        return trueques.filter(t => t.efectivizar == false && t.sucursal == usuarioActual.puntos) //comparo con puntos porque no existe sucursal todavia en mongo
      }
      return trueques.filter(t => t.efectivizar == false)
    }
    return []
  }*/
