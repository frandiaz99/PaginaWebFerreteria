...
const uri = "mongodb+srv://cluster0.trqsger.mongodb.net/?authSource=%24external&authMechanism=MONGODB-X509&retryWrites=true&w=majority&appName=Cluster0";
const clientOptions = {
  tlsCertificateKeyFile: credentials,
  serverApi: { version: '1', strict: true, deprecationErrors: true }
};

mongoose.connect(uri, clientOptions).then((data) => {
